...
function updatePreview() {
  ...
  const finish = remainingAtStart ? addWorkingSeconds(start, bufferedRemaining, scheduleSettings(includeEveningShift)) : start;
...
function attachEvents() {
  ...
  ["#totalQuantity", "#perCarton", "#preCompletedCartons", "#preCompletedLoose", "#includeEveningShift", "#leadTime", "#leadUnit", "#bufferPercent", "#startDateTime"].forEach((selector) => {
